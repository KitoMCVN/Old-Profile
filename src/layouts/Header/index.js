  ...
  return (
    <div className='p-5 rounded-xl bg-white shadow-sm'>
      ...
      <div className='flex mt-4 gap-2'>
        <Tippy animation='scale' content='Mail'>
          <a target='_blank' rel='noopener noreferrer' className='rounded-full bg-cyan-600 p-[6px] hover:bg-cyan-500' href='kitomcchill@gmail.com'>
        ...
        <Tippy animation='scale' content='Github'>
          <a target='_blank' rel='noopener noreferrer' className='rounded-full bg-cyan-600 p-[6px] hover:bg-cyan-500' href='https://github.com/kitomcvn'>
        ...
        <Tippy animation='scale' content='Discord'>
          <a target='_blank' rel='noopener noreferrer' className='rounded-full bg-cyan-600 p-[6px] hover:bg-cyan-500' href='https://discordredirect.discordsafe.com/users/915876843884777472'>
            <svg className='w-6 h-6 text-gray-800 dark:text-white' aria-hidden='true' xmlns='http://www.w3.org/2000/svg' fill='currentColor' viewBox='0 0 24 24'>
        ...
        <Tippy animation='scale' content='Youtube'>
          <a target='_blank' rel='noopener noreferrer' className='rounded-full bg-cyan-600 p-[6px] hover:bg-cyan-500' href='https://youtube.com/@kitomc'>
            <svg className='w-6 h-6 text-gray-800 dark:text-white' aria-hidden='true' xmlns='http://www.w3.org/2000/svg' fill='currentColor' viewBox='0 0 24 24'>
              <path
                fillRule='evenodd'
        ...
        <Tippy animation='scale' content='Facebook'>
          <a target='_blank' rel='noopener noreferrer' className='rounded-full bg-cyan-600 p-[6px] hover:bg-cyan-500' href='https://fb.com/kitomcvn'>
            <svg className='w-6 h-6 text-gray-800 dark:text-white' aria-hidden='true' xmlns='http://www.w3.org/2000/svg' fill='currentColor' viewBox='0 0 24 24'>
